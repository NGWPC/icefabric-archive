...
def module_ipe(module,attr,domain,version):
    ...
    datatypes = {'name':'object','description':'object','units':'object','data_type':'object','calibratable':'bool',
                 'source':'object','min':'float64','max':'float64','default_value':'object','divide_attr_name':'object',
                 'source_file':'object'}
    ...
    attr_name_map = dict(zip(attr_list, attr_names))
