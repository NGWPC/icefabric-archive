...
def build_table(file_dir):
    ...
    """
    parquet_tables = {'CFE-X_params_Alaska_2.2.parquet':'CFE-X_Alaska', 'CFE-X_params_GL_2.2.parquet':'CFE-X_GL',
        'CFE-X_params_Puerto_Rico_2.2.parquet':'CFE-X_Puerto_Rico', 'snow17_params_2.2.parquet':'Snow-17_CONUS',
        'CFE-X_params_CONUS_2.2.parquet':'CFE-X_CONUS', 'CFE-X_params_Hawaii_2.2.parquet':'CFE-X_Hawaii',
        'sac_sma_params_2.2.parquet':'Sac-SMA_CONUS', 'ueb_params.parquet':'UEB_CONUS'}
