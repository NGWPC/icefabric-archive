...
from icefabric_tools.icechunk.icechunk_testing import *

def migrate_all_icechunks(attr_name):
    '''
    Converts & migrates TIFFs from local to cloud.

    Args: 
        attr_name (str): Attribute name of interest for a given TIFF.
    ...
    for fn in local_list:
        if 'hawaii_10m' in fn:
            ...
            topo_fn2s3_map[NGWPCLocations.TOPO_CONUS_ATL_GULF_30M_IC.path] = 'tbdem_conus_atlantic_gulf_30m.tiff'  
